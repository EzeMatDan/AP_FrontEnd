...
@Component({
  selector: 'app-edit-circle5',
  templateUrl: './edit-circle5.component.html',
  styleUrls: ['./edit-circle5.component.css']
})
export class EditCircle5Component implements OnInit {
