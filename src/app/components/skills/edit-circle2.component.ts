...
@Component({
  selector: 'app-edit-circle2',
  templateUrl: './edit-circle2.component.html',
  styleUrls: ['./edit-circle2.component.css']
})
export class EditCircle2Component implements OnInit {
