...
@Component({
  selector: 'app-edit-circle4',
  templateUrl: './edit-circle4.component.html',
  styleUrls: ['./edit-circle4.component.css']
})
export class EditCircle4Component implements OnInit {
